...
```shell script
# Close lottery.
0 0 * * * cd ~/cosmicswap-lottery-scheduler && yarn execute:close:mainnet

# Draw lottery.
3 0 * * * cd ~/cosmicswap-lottery-scheduler && yarn execute:draw:mainnet

# Start lottery.
5 0 * * * cd ~/cosmicswap-lottery-scheduler && yarn execute:start:mainnet
```
